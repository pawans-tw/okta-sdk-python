...
class User:
    ...
    def __init__(self, **kwargs):
        ...
        # Populate profile
        profile_attrs = ['login', 'email', 'employeeNumber', 'secondEmail', 'firstName', 'lastName', 'mobile_phone', 'telephone', 'country', 'homeOffice', 'workingOffice', 'department', 'departmentCode', 'role', 'joinDate']
